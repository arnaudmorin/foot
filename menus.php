...
if (isset($_SESSION['user']) && isset($_SESSION['friendlist']) && count($_SESSION['user']->friendlists) > 1){
    ...
    echo "<div class='menu-select-friendlist-div'>".$lang['menu-friendlist-selector']."<select name='change-friendlist-requested' class='menu-select-friendlist' onchange='submit();'>";
