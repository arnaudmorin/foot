...
class Friendlist{
    ...
    function __construct($name, $autobuild = true) {
        ...
        if ($autobuild){
            // Get most of info
            $req = "SELECT * FROM friendlists WHERE name = '".mysql_real_escape_string($name)."'";
            ...
            // Get members
            $req = "SELECT * FROM friendlists_membership WHERE friendlist_name = '".mysql_real_escape_string($name)."'";
